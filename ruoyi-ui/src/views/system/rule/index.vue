<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="消费金额" prop="consumMoney">
        <el-input
          v-model="queryParams.consumMoney"
          placeholder="请输入消费金额"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="获得积分" prop="consumPoint">
        <el-input
          v-model="queryParams.consumPoint"
          placeholder="请输入获得积分"
          clearable
          @keyup.enter.native="handleQuery"
        />
...
<!--      <el-table-column label="id" align="center" prop="ruleId" />-->
      <el-table-column label="消费金额" align="center" prop="consumMoney" />
      <el-table-column label="获得积分" align="center" prop="consumPoint" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="消费金额" prop="consumMoney">
          <el-input v-model="form.consumMoney" placeholder="请输入消费金额" />
        </el-form-item>
        <el-form-item label="获得积分" prop="consumPoint">
          <el-input v-model="form.consumPoint" placeholder="请输入获得积分" />
        </el-form-item>
      </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$modal.confirm('是否确认删除消费规则编号为"' + ruleIds + '"的数据项？').then(function() {
